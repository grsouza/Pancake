...
extension CoreDataStack {
  ...
  public typealias FilterAndCreateClosure<Internal, External> = ([Internal], NSManagedObjectContext) throws -> ([Internal], [External])

  public func exists<Entity: NSManagedObject & CoreDataEntity>(
  ...
  public func fetch<Internal: NSManagedObject & CoreDataEntity, External>(
  ...
  public func findOrCreate<Internal: NSManagedObject & CoreDataEntity, External>(
    with predicate: NSPredicate,
    contextType: CoreDataStackContextType = .work,
  ...
  public func create<Internal: NSManagedObject & CoreDataEntity, External>(
    contextType: CoreDataStackContextType = .work,
  ...
  public func createOrUpdate<Internal: NSManagedObject & CoreDataEntity, External>(
    with predicate: NSPredicate,
    sortDescriptors: [NSSortDescriptor]? = nil,
    contextType: CoreDataStackContextType = .work,
  ...
  public func update<Internal: NSManagedObject & CoreDataEntity, External>(
    with predicate: NSPredicate,
    sortDescriptors: [NSSortDescriptor]? = nil,
    fetchLimit: Int = 0,
    contextType: CoreDataStackContextType = .work,
  ...
  public func delete<Entity: NSManagedObject & CoreDataEntity>(
    _ entity: Entity.Type = Entity.self,
    predicate: NSPredicate,
    fetchLimit: Int = 0,
    contextType: CoreDataStackContextType = .work,
  ...
  public func count<Entity: NSManagedObject & CoreDataEntity>(
    _ entity: Entity.Type,
    with predicate: NSPredicate,
    contextType: CoreDataStackContextType = .work
  ) throws -> Int {
  ...
  public func performClosure<Entity: NSManagedObject & CoreDataEntity>(
    _ entity: Entity.Type,
    with predicate: NSPredicate,
    sortDescriptors: [NSSortDescriptor]? = nil,
    fetchLimit: Int = 0,
